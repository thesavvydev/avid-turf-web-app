...
alter table "public"."business_location_job_products" add column "unit_price" double precision default '0'::double precision;
...
alter table "public"."business_products" add column "unit" text default 'sq ft'::text;

alter table "public"."business_products" add column "unit_price" double precision;
